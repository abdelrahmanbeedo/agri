      ...
      <Link to={`/products/${product._id}`} className="block">
        <div className="aspect-[4/3] bg-sage-50 overflow-hidden relative">
          ...
          {product.average_rating > 0 && (
            <span className="absolute top-3 right-3 px-2 py-1 bg-white/90 backdrop-blur-sm text-xs font-medium text-gray-700 rounded-lg shadow-sm flex items-center gap-1">
